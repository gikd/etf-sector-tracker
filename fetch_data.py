...
TICKERS = [
    ...
    # 한국 섹터 (index '한국 ETF 보기' 토글 전용 — 글로벌 시그널/비교표엔 미포함)
    ("091160.KS", "반도체",       "korea", "South Korea semiconductor stocks"),
    ("305720.KS", "2차전지",      "korea", "South Korea battery EV stocks"),
    ("364980.KS", "2차전지소재",  "korea", "South Korea battery materials stocks"),
    ("091180.KS", "자동차",       "korea", "South Korea automotive Hyundai Kia stocks"),
    ("091170.KS", "은행",         "korea", "South Korea bank financial stocks"),
    ("244580.KS", "바이오",       "korea", "South Korea biotech pharma stocks"),
    ("449450.KS", "방산",         "korea", "South Korea defense aerospace stocks"),
    ("466920.KS", "조선",         "korea", "South Korea shipbuilding stocks"),
    ("157500.KS", "인터넷",       "korea", "South Korea internet Naver Kakao stocks"),
    ("442320.KS", "원자력",       "korea", "South Korea nuclear power stocks"),
    ("445290.KS", "로봇",         "korea", "South Korea robotics stocks"),
    ("229200.KS", "코스닥150",    "korea", "South Korea KOSDAQ growth stocks"),
]
...
CONSTITUENTS = {
    ...
    # 한국 섹터 ETF 대표 구성종목
    "091160.KS": [("005930.KS", "삼성전자"), ("000660.KS", "SK하이닉스"), ("042700.KS", "한미반도체"), ("000990.KS", "DB하이텍"), ("058470.KS", "리노공업")],
    "305720.KS": [("373220.KS", "LG에너지솔루션"), ("006400.KS", "삼성SDI"), ("005490.KS", "POSCO홀딩스"), ("051910.KS", "LG화학"), ("247540.KS", "에코프로비엠")],
    "364980.KS": [("247540.KS", "에코프로비엠"), ("003670.KS", "포스코퓨처엠"), ("066970.KS", "엘앤에프"), ("086520.KS", "에코프로"), ("020150.KS", "롯데에너지머티리얼즈")],
    "091180.KS": [("005380.KS", "현대차"), ("000270.KS", "기아"), ("012330.KS", "현대모비스"), ("204320.KS", "HL만도"), ("011210.KS", "현대위아")],
    "091170.KS": [("105560.KS", "KB금융"), ("055550.KS", "신한지주"), ("086790.KS", "하나금융지주"), ("316140.KS", "우리금융지주"), ("323410.KS", "카카오뱅크")],
    "244580.KS": [("207940.KS", "삼성바이오로직스"), ("068270.KS", "셀트리온"), ("196170.KS", "알테오젠"), ("000100.KS", "유한양행"), ("128940.KS", "한미약품")],
    "449450.KS": [("012450.KS", "한화에어로스페이스"), ("064350.KS", "현대로템"), ("079550.KS", "LIG넥스원"), ("272210.KS", "한화시스템"), ("047810.KS", "한국항공우주")],
    "466920.KS": [("009540.KS", "HD한국조선해양"), ("010140.KS", "삼성중공업"), ("042660.KS", "한화오션"), ("329180.KS", "HD현대중공업")],
    "157500.KS": [("035420.KS", "NAVER"), ("035720.KS", "카카오"), ("259960.KS", "크래프톤"), ("036570.KS", "엔씨소프트"), ("376300.KS", "디어유")],
    "442320.KS": [("034020.KS", "두산에너빌리티"), ("052690.KS", "한전기술"), ("051600.KS", "한전KPS"), ("100090.KS", "삼강엠앤티"), ("018880.KS", "한온시스템")],
    "445290.KS": [("277810.KS", "레인보우로보틱스"), ("454910.KS", "두산로보틱스"), ("005930.KS", "삼성전자"), ("108860.KS", "셀바스AI"), ("056080.KS", "유진로봇")],
    "229200.KS": [("247540.KS", "에코프로비엠"), ("086520.KS", "에코프로"), ("196170.KS", "알테오젠"), ("028300.KS", "HLB"), ("058470.KS", "리노공업")],
